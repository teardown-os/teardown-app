...
const ScreenHeader = ({ children, className, ...props }: ScreenHeaderProps) => {
	return (
...
const ScreenFooter = ({
	...
	return (
		...
		>
			<View style={{ paddingBottom: !sticky ? bottom : 0 }}>{children}</View>
		</Component>
	);
};

export { ScreenContent, ScreenFooter, ScreenHeader, ScreenRoot };
